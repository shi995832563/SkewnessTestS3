...
if (n<=100) {wa=1} else {wa=1-0.7*(log10(n)-2)}  ##0.7 or 0.1
...
x=rlnorm(n, meanlog = 0, sdlog = 0.1)
...
##################
x=rweibull(n, shape=2.5, scale = 3) 
...
x=rtnorm(n,0,1,lower=-1.5,upper=Inf)  #trunc_norm
...
#save(B1,B2, B3,B4,B5,B6, m, file="power_ratioBala_s10w.RData")
